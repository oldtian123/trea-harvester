...
function execCommand(command, options = {}) {
    return new Promise((resolve) => {
        ...
        const child = (0, child_process_1.exec)(command, opts, (error, stdout, stderr) => {
            resolve({
 ...
 */
function spawnCommand(command, args = [], options = {}, timeoutMs = 0) {
 ...
 */
function runShellCommand(fullCommand, cwd, timeoutMs = 0) {
